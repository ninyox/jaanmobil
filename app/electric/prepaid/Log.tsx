...
export const Log = async ({provider,accountnumber,amount,serviceType,mobile}:{provider:string,accountnumber:string,amount:number,serviceType:string,mobile:string}) => {
...
const formData = JSON.stringify({
  ...
  try {
    const response = await BaseUrl.post(
      "/api/v1/service/electric/purchase",
      formData,
      {
        headers: {
