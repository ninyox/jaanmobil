    ...
    <>
      <Custommodal visible={visible} close={close}>
        ...
        <View className="w-full h-auto">
          ...
          >
            <MaterialCommunityIcons name="bank-outline" size={15} />
            <Text className="font-intermedium text-twelve mx-4">
              Account Balance
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            onPress={() => submit("card")}
          >
            <Octicons name="credit-card" size={15} />
            <Text className="font-intermedium text-twelve mx-4">Card Payment</Text>
          </TouchableOpacity>
        </View>
      </Custommodal>
    </>
