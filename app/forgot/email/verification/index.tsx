    ...
    return (
        <>
            <Customview>
                ...
                <View className="flex flex-col py-6 w-full h-auto items-center px-3 bg-white min-h-screen dark:bg-dark ">
                    <View className="w-full flex items-center h-auto">
                        ...
                        <View id="logo-container" className="w-full bg-transparent rounded-md h-auto justify-start flex-col items-start mt-4">
                            ...
                            <Text className="text-xl font-interbold text-[#333333] dark:text-white mt-2 mb-1">Verify Your Email</Text>
                            <Text className="text-[10px] font-inter text-[#616161]">enter the verification code sent to your email address</Text>
                            <Text className="text-[12px] font-interbold text-black dark:text-white mt-2">{email}</Text>
                        ...
                        <View id="email container" className="my-8 w-full bg-transparent justify-start items-start flex flex-col">
                            ...
                            <View className="w-full flex flex-row justify-between mt-2">
                                <Text className="text-[#333333] font-intermedium text-[12px] dark:text-white my-3">
                    ...
                    <View id="button-container" className="w-full flex items-center pb-10 absolute bottom-10 ">
